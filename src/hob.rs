...
/// use core::ffi::c_void;
///
/// // Assuming `hob_list_ptr` is a valid pointer to a HOB list
/// let hob_list_ptr: *const c_void = ...;
/// let size = get_c_hob_list_size(hob_list_ptr);
/// println!("HOB list size: {}", size);
/// ```
pub fn get_c_hob_list_size(hob_list: *const c_void) -> usize {
